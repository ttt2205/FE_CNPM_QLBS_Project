...
//     const containerRef = useRef(null); // Bootstrap container ref
...
//             ref={isMobile ? containerRef : searchContainerRef} // Thay đổi ref dựa trên điều kiện
//             onMouseLeave={() => setShowSearchPanel(true)} // Hide search panel when mouse leaves
