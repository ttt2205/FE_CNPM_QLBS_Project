    ...
    <Form method="post" onSubmit={validate}>
      ...
      <div className="form-group">
        ...
        <input
          ...
          defaultValue={""}
        />
        {errors.num_page && <p style={{ color: "red" }}>{errors.num_page}</p>}
      </div>
      <div className="form-group">
        <label>Size</label>
        <input
      ...
      <div className="form-group">
        ...
        <input type="text" className="form-control" name="stock_quantity" />
      ...
      <div className="form-group">
        ...
        <select className="form-select" name="discount_id" defaultValue={""}>
      ...
      <div className="form-group">
        ...
        <select className="form-select" name="cover_format_id">
          {allReferences.coverformats.map((coverformat) => (
            <option value={coverformat.cover_id}>{coverformat.name}</option>
          ))}
        </select>
      </div>
